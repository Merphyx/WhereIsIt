...
public abstract class RenderUtils {
    ...
    public static void renderHighlights(WorldRenderContext context, Boolean simpleRendering) {
        ...
        stack.multiply(new Quaternionf(new AxisAngle4f((float) Math.toRadians(camera.getPitch()), new Vector3f(1.0f, 0.0f, 0.0f))));
        stack.multiply(new Quaternionf(new AxisAngle4f((float)Math.toRadians(camera.getYaw() + 180.0f), new Vector3f(0.0f, 1.0f, 0.0f))));
